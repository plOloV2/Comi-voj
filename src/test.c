...
int main(int argc, const char **argv)
{
    ...
    // puts("\n## My own tests ##");
    // fprintf(stdout, "=> " ANSI_COLOR_RED "This text is RED!" ANSI_RESET_ALL "\n");
    // fprintf(stdout, "=> " ANSI_COLOR_RED ANSI_STYLE_BOLD "This text is BOLD and RED!" ANSI_RESET_ALL "\n");
    // fprintf(stdout, "=> " ANSI_COLOR_RED ANSI_STYLE_BOLD ANSI_BACKGROUND_WHITE "This text is BOLD and RED!" ANSI_RESET_ALL "\n");
